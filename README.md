...
[![My Skills]([https://skillicons.dev/icons?i=git,docker,kubernetes,vim,linux](https://skillicons.dev/icons?i=java,spring,py,kali,ubuntu,docker,git,mysql,postgres,gmail))](https://skillicons.dev)
